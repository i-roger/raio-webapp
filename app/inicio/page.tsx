  ...
  return (
    <div className="flex flex-col items-center justify-center mb-20">
      ...
      <div className='w-full md:w-[900px]'>
        <SwiperComponent/>
        <Card cor='bg-orange-500' titulo='Essa é para você que corre na esteira!' texto='Digite seu pace e veja qual é a velocidade correspondente em KM/H. Assim você consegue colocar a velocidade correta na sua esteira.' namebtn='Eu corro na esteira!' href='/ferramentas/conversoes/pace-para-kmh'/>
        <div className="flex bg-zinc-800/70 mt-2 mb-10 rounded-xl m-2">
